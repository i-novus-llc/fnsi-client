...
public class PassportDto implements Serializable
{
    ...
    private final static long serialVersionUID = 6160426068208446704L;
    ...
    public PassportDto withResult(String result) {
        this.result = result;
        return this;
    }
    ...
    public PassportDto withResultText(String resultText) {
        this.resultText = resultText;
        return this;
    }
    ...
    public PassportDto withResultCode(String resultCode) {
        this.resultCode = resultCode;
        return this;
    }
    ...
    public PassportDto withIdentifier(String identifier) {
        this.identifier = identifier;
        return this;
    }
    ...
    public PassportDto withOid(String oid) {
        this.oid = oid;
        return this;
    }
    ...
    public PassportDto withVersion(String version) {
        this.version = version;
        return this;
    }
    ...
    public PassportDto withRowsCount(Integer rowsCount) {
        this.rowsCount = rowsCount;
        return this;
    }
    ...
    public PassportDto withCreateDate(String createDate) {
        this.createDate = createDate;
        return this;
    }
    ...
    public PassportDto withPublishDate(String publishDate) {
        this.publishDate = publishDate;
        return this;
    }
    ...
    public PassportDto withLastUpdate(String lastUpdate) {
        this.lastUpdate = lastUpdate;
        return this;
    }
    ...
    public PassportDto withFullName(String fullName) {
        this.fullName = fullName;
        return this;
    }
    ...
    public PassportDto withShortName(String shortName) {
        this.shortName = shortName;
        return this;
    }
    ...
    public PassportDto withDescription(String description) {
        this.description = description;
        return this;
    }
    ...
    public PassportDto withStructureNotes(String structureNotes) {
        this.structureNotes = structureNotes;
        return this;
    }
    ...
    public PassportDto withReleaseNotes(String releaseNotes) {
        this.releaseNotes = releaseNotes;
        return this;
    }
    ...
    public PassportDto withLaw(String law) {
        this.law = law;
        return this;
    }
    ...
    public PassportDto withRespOrganizationId(Integer respOrganizationId) {
        this.respOrganizationId = respOrganizationId;
        return this;
    }
    ...
    public PassportDto withAuthOrganizationId(Integer authOrganizationId) {
        this.authOrganizationId = authOrganizationId;
        return this;
    }
    ...
    public PassportDto withTypeId(Integer typeId) {
        this.typeId = typeId;
        return this;
    }
    ...
    public PassportDto withGroupId(Integer groupId) {
        this.groupId = groupId;
        return this;
    }
    ...
    public PassportDto withApproveDate(String approveDate) {
        this.approveDate = approveDate;
        return this;
    }
    ...
    public PassportDto withFields(List<FieldDto> fields) {
        this.fields = fields;
        return this;
    }
    ...
    public PassportDto withKeys(List<KeyDto> keys) {
        this.keys = keys;
        return this;
    }
    ...
    public PassportDto withCodes(List<CodeDto> codes) {
        this.codes = codes;
        return this;
    }
    ...
    public PassportDto withArchive(Boolean archive) {
        this.archive = archive;
        return this;
    }
    ...
    public PassportDto withHierarchical(Boolean hierarchical) {
        this.hierarchical = hierarchical;
        return this;
    }
    ...
    public PassportDto withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PassportDto) == false) {
            return false;
        }
        PassportDto rhs = ((PassportDto) other);
