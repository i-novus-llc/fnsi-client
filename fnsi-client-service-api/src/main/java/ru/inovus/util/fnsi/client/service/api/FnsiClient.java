...
public interface FnsiClient {
     ...
     * @throws ValidationsException Выбрасываются исключения, если аргументы не были заполнены верно
     */
     ...
     * <p>
     * Функция получения структуры и паспорта справочника.
     * Структура справочника описывает список полей, ключей, служебную информацию.
     * В случае, если не задан номер версии, информация выводится для актуальной версии справочника.
     *
     * @param query    Набор данных для формирования параметров запроса
     * @param settings Метаданные соединения
     ...
     * <p>
     * Функция получения данных справочника.
     * Обеспечивается работа с линейными и иерархическими справочниками.
